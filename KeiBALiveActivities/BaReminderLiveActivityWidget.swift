...
@main
struct KeiBALiveActivityWidgets: WidgetBundle {
...
private struct BaReminderBrandChip: View {
    ...
    var body: some View {
        HStack(spacing: 6) {
            KeiBALiveActivityIcon(size: iconSize)
...
private struct KeiBALiveActivityIcon: View {
    var size: CGFloat

    var body: some View {
        Image("KeiBALiveActivityIcon")
            .resizable()
            .scaledToFill()
