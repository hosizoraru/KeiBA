...
private let iconSetURL = URL(fileURLWithPath: FileManager.default.currentDirectoryPath)
    .appendingPathComponent("KeiBA/Assets.xcassets/AppIcon.appiconset")
...
private func renderContactSheet(light: CGImage, dark: CGImage, tinted: CGImage) {
    ...
    writePNG(sheet, to: URL(fileURLWithPath: "/tmp/keiba-icon-preview.png"))
}
...
print("Generated KeiBA app icons in \(iconSetURL.path)")
print("Preview: /tmp/keiba-icon-preview.png")
